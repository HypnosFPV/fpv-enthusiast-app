...
export const GROUP_CARD_ANIMATION_VARIANTS: GroupCardAnimationVariant[] = [
  ...
  },
  {
    ...
    priceCents: 99,
    badge: 'Starter',
    description: 'Adds a restrained electrical pulse that rides the card perimeter while keeping the carbon weave dark and readable.',
  },
  {
    id: 'standard',
    name: 'Perimeter charge',
    tier: 'paid',
    priceCents: 199,
    badge: 'Charged',
    description: 'Builds a stronger full-edge current with faster perimeter travel and more visible electrical hits around the frame.',
  },
  {
    id: 'premium',
    name: 'Electric storm',
    ...
    priceCents: 299,
    badge: 'Storm',
    description: 'Turns the whole card into a true carbon-fiber panel with aggressive animated lightning running the perimeter in your theme color.',
  },
];
